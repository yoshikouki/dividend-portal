  ...
  describe "#updated?" do
    ...
    context "引数を元にインスタンスの値を比較して異なっていた場合" do
      it "true を返す" do
        ...
        expect(dividend.updated?(attributes.merge(record_date: "2001-12-01"))).to be true
        expect(dividend.updated?(attributes.merge(payment_date: "2001-12-01"))).to be true
        expect(dividend.updated?(attributes.merge(declaration_date: "2001-12-01"))).to be true
